...
```
## Output:
![image](https://github.com/user-attachments/assets/57f7bf46-afd3-4652-9d34-12f754ca5e91)
...
## Aim:
To write a C program to print ten space-separated integers in a single line denoting the frequency of each digit from 0 to 3. Algorithm:
...
```
## Output:
![image](https://github.com/user-attachments/assets/97eefeab-cadc-4d83-ac12-651f9388d840)
...
```
## Output:
![image](https://github.com/user-attachments/assets/769c0ba5-1a92-4d47-a6f7-b06cb89fb7a9)
...
```
Output:
![image](https://github.com/user-attachments/assets/32e8ba12-837a-4734-987f-7fc87f3f17b3)
...
```
## Output:
![image](https://github.com/user-attachments/assets/ec790add-7788-4db3-bd00-04503df7e3b7)
